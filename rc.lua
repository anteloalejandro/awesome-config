...
local custom_settings = require("custom_settings")
...
local terminal = custom_settings.apps.terminal
...
-- {{{ Key bindings
globalkeys = custom_mappings.globalkeys

clientkeys = custom_mappings.clientkeys
...
gears.wallpaper.maximized("wallpapers/linux-gruv-light.svg", nil, false)
